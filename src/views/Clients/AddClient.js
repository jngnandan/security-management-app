    ...
    <div className="p-4 w-screen pr-8">
      ...
      <form ref={inputRef} onSubmit={handleSubmit} className='grid grid-cols-2 gap-y-4 mt-6'>
        <div className="flex flex-col">
          ...
          <input ref={inputRef} value={clientName} onChange={(e) => setClientName(e.target.value)} className='border rounded pl-3 py-2 placeholder:text-sm w-4/5' type="text" name="name" id="name" placeholder='Client Name' />
        </div>
        
          <div className="flex flex-col">
          <label className='font-semibold text-gray-800 text-sm pb-1'  htmlFor="address">Invoice terms</label>
          <select ref={inputRef} onChange={(e) => setInvoiceTerms(e.target.value)} className='h-10 border rounded pl-3 placeholder:font-sm w-4/5' name="type" id="type">
        ...
        <div className="flex flex-col">
          ...
          <textarea ref={inputRef} value={clientAddress} onChange={(e) => setClientAddress(e.target.value)} className='border rounded pl-3 py-2 placeholder:text-sm w-4/5' type="text" name="address" id="address" placeholder='Address' />
        </div>

        <div className="flex flex-col">
          <label className='font-semibold text-gray-800 text-sm pb-1'  htmlFor="address">Payment Terms</label>
          <textarea ref={inputRef} value={paymentTerms} onChange={(e) => setPaymentTerms(e.target.value)} className='border rounded pl-3 py-2 placeholder:text-sm w-4/5' type="text" name="address" id="address" placeholder='Payment Terms' />
        </div>

        <div className="flex flex-col">
          <label  className='font-semibold text-gray-800 text-sm pb-1' htmlFor="name">Contact Person</label>
          <input ref={inputRef} value={contactPerson} onChange={(e) => setContactPerson(e.target.value)} className='border rounded pl-3 py-2 placeholder:text-sm w-4/5' type="text" name="name" id="name" placeholder='Contact Person' />
        </div>

        <div className="flex flex-col">
          <label className='font-semibold text-gray-800 text-sm pb-1' htmlFor="date">Contact Start</label>
          <input ref={inputRef} value={contractStartDate} onChange={(e) => setContractStartDate(e.target.value)} className='border rounded pl-3 py-2 placeholder:text-sm w-4/5' type="date" name="name" id="name" placeholder='00/00/0000' />
        </div>

      <div className="flex flex-col">
          <label className='font-semibold text-gray-800 text-sm pb-1'  htmlFor="phone">Contact Number</label>
          <input ref={inputRef} value={contactNumber} onChange={(e) => setContactNumber(e.target.value)} className='border rounded pl-3 py-2 placeholder:text-sm w-4/5' type="tel" name="phone" id="phone" placeholder='Contact Number' />
        </div>

        <div className="flex flex-col">
          <label className='font-semibold text-gray-800 text-sm pb-1' htmlFor="date">Contact End</label>
          <input ref={inputRef} value={contractEndDate} onChange={(e) => setContractEndDate(e.target.value)} className='border rounded pl-3 py-2 placeholder:text-sm w-4/5' type="date" name="date" id="name" placeholder='' />
        </div>

        <div className="flex flex-col">
          <label className='font-semibold text-gray-800 text-sm pb-1'  htmlFor="phone">Contact Fax</label>
          <input ref={inputRef} value={contactFax} onChange={(e) => setContactFax(e.target.value)} className='border rounded pl-3 py-2 placeholder:text-sm w-4/5' type="tel" name="phone" id="phone" placeholder='Contact Fax' />
        </div>

          <div className="flex flex-col">
          <label className='font-semibold text-gray-800 text-sm pb-1'  htmlFor="charge">Charge Rate (Guard)</label>
          <input ref={inputRef} value={chargeRate} onChange={(e) => setChargeRate(e.target.value)} className='border rounded pl-3 py-2 placeholder:text-sm w-4/5' type="text" name="charge" id="phone" placeholder='Contact Fax' />
        </div>

        <div className="flex flex-col">
          <label className='font-semibold text-gray-800 text-sm pb-1' htmlFor="email">Email</label>
          <input ref={inputRef} value={contactEmail} onChange={(e) => setContactEmail(e.target.value)} className='border rounded pl-3 py-2 placeholder:text-sm w-4/5' type="email" name="email" id="email" placeholder='Email' />
        </div>

        <div className="flex flex-col">
          <label className='font-semibold text-gray-800 text-sm pb-1'  htmlFor="charge">Charge Rate (Supervisor)</label>
          <input ref={inputRef} value={chargeRateSupervisor} onChange={(e) => setChargeRateSupervisor(e.target.value)} className='border rounded pl-3 py-2 placeholder:text-sm w-4/5' type="text" name="charge" id="phone" placeholder='Contact Fax' />
        </div>

        {/* checkbox */}
        <div className="flex flex-row justify-start items-center col-span-2">
          <input ref={inputRef} className='' type="checkbox" name="charge" id="phone" placeholder='Contact Fax' />
